                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('update.about') }}" class="needs-validation" method="post"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <textarea name="short_description" class="form-control" value="" rows="5">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <img id="showImage" class="rounded avatar-lg"
                                            src="{{ !empty($aboutpage->about_image) ? url($aboutpage->about_image) : url('upload/banner_img.png') }}"
                                            alt="Card image cap">
                                    </div>
                                </div>
                                <!-- end row -->
