                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('update.slide') }}" class="needs-validation" method="post"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="home_slide_image" class="form-control" type="file" id="image">
                                    </div>
                                </div>
                                <!-- end row -->
